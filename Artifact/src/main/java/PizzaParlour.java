...
public class PizzaParlour {
	...
	static Drink getDrinksLoop(Scanner scanner) {
		...
		while (true) { // 1045
			...
			System.out.println(
					"[(1) Coke, (2) Diet Coke, (3) Coke Zero, (4) Pepsi, (5) Diet Pepsi, (6) Dr. Pepper, (7) Water, (8) Juice, (9) Cancel]");
	...
	static Pizza getPizzasLoop(Scanner scanner) {
		...
		List<String> validTypes = new ArrayList<>(
				Arrays.asList("Pepperoni", "Margherita", "Vegetarian", "Neapolitan", "Custom", "Cancel"));
		List<String> validToppings = new ArrayList<>(Arrays.asList("Olives", "Tomatoes", "Mushrooms", "Jalapenos",
				"Chicken", "Beef", "Pepperoni", "Undo", "Done", "Cancel"));
		String userInput;
		...
		if (type.equals("Custom")) {
			...
			while (!next_topping.equals("Done")) { // 1026
				...
				// 1027
				System.out.println(
						"Pick a topping! [Olives, Tomatoes, Mushrooms, Jalapenos, Chicken, Beef, Pepperoni, Undo, Done, Cancel]");
	...
	static String submitDelivery(Order order) {
		String result = "Your order #" + String.valueOf(order.getOrderNum())
				+ " will be delivered as soon as possible to: ";
	...
	static String submitUber(Order order) {
		...
		// try (PrintWriter o = new PrintWriter(System.getProperty("user.dir") +
		// "/Result.txt")) {
		// o.println(result);
	...
	private static Pizza changePizza(Pizza pizza, Scanner scanner) {
		...
		List<String> validTypes = new ArrayList<>(
				Arrays.asList("Pepperoni", "Margherita", "Vegetarian", "Neapolitan", "Custom"));
		List<String> validToppings = new ArrayList<>(Arrays.asList("Olives", "Tomatoes", "Mushrooms", "Jalapenos",
				"Chicken", "Beef", "Pepperoni", "Undo", "Done"));
		String userInput;
		...
		while (type.equals("Custom")) {
			System.out.println(
					"Pick a topping! [Olives, Tomatoes, Mushrooms, Jalapenos, Chicken, Beef, Pepperoni, Undo, Done, Clear]");
	...
	public static List<Order> runApp(String input, String menuName) {// Node 4
		...
		while (true) {
			...
			System.out.println(
					"[(1) Create an Order, (2) Update an Order, (3) Delete an Order, (4) Submit an Order, (5) View Menu, (6) Quit App]");
